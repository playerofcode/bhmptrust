<div class="page-wrapper">
            ...
            <?php endif;?>
       			<div class="card ">
					...
					<div class="form-group">
						<label>Title</label>
						<input type="text" name="title" class="form-control" value="<?php echo set_value('title'); ?>"placeholder="Enter Blog Title">
					...
					<div class="form-group">
						...
						<textarea name="description" id="ckeditor"  cols="30" rows="5" class="form-control" =><?php echo set_value('description'); ?></textarea>
