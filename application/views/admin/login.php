            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db font-weight-bold text-white"><h2><!-- <img src="<?php echo base_url('assets/ad min/'); ?>assets/images/logo.png" alt="logo" /> -->Admin Panel</h2></span>
                    </div>
                    <!-- Form -->
                    <?php if($this->session->flashdata('msg')): ?>
                     <div class="alert alert-warning"><?php echo $this->session->flashdata('msg');?></div>
                    <?php endif;?>
                    <form class="form-horizontal m-t-20" id="loginform" action="<?php echo base_url('admin/login');?>" method="post">
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="email" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                        ...
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="p-t-20">
                                        <a href="<?php echo base_url();?>"class="btn btn-info text-white" id="to-recover"><i class="fa fa-home m-r-5"></i> Go to Home</a>
