<div class="page-wrapper">
          ...
          <form action="<?php echo base_url('admin/updateblog');?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label>Choose Block Category</label>
                <select name="cat_id" class="form-control">
                    <?php foreach($blog_category as $row):?>
                        <option value="<?php echo $row->cat_id;?>" <?php if($row->cat_id=$key->cat_id):echo 'selected';endif;?>><?php echo $row->cat_name;?></option>
                    <?php endforeach;?>
                </select>
                  </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <textarea name="description" id="ckeditor" cols="30" rows="5" class="form-control" ><?php echo set_value('description',$key->description); ?></textarea>
