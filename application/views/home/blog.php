...
<li><a href="#" class="color-facebook" target="_blank"><i class="fa fa-facebook"></i>Facebook</a></li>
<li><a href="#" class="color-twitter" target="_blank"><i class="fa fa-twitter"></i>twitter</a></li>
<li><a href="#" class="color-instagram" target="_blank"><i class="fa fa-instagram"></i>Instagram</a></li>
<li><a href="https://api.whatsapp.com/send?phone=<?php echo MOBNO1;?>" class="color-linkedin"><i class="fa fa-whatsapp"></i>Whatsapp</a></li>
</ul>
</div>
