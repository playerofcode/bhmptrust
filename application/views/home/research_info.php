...
<span class="post-cat">
<i class="fa fa-folder-open"></i><a href="javascript:void(0);">Mahima Career Institute</a>
</span>
</div>
</div>
...
<div class="widget widget_search">
	<div class="card">
		...
		<div class="card-body text-center">
			<a href="<?php echo base_url($key->pdf);?>" target="_blank" class="btn btn-primary">Download PDF</a>
		</div>
	</div>
