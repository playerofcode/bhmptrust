...
<a href="<?php echo base_url('home/research_info/'.$key->id);?>"><?php echo $key->title; ?></a><br>
<?php 
...
if (strlen($string) > 200) {
    ...
    $string .= '<a style="font-size:14px;" href="'.base_url('home/research_info/').$key->id.'">...Read More</a>';
}
echo $string;
 ?>
</div>
