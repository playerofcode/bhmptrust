<section class="xs-banner-inner-section parallax-window" style="background-image:url('<?php echo base_url();?>assets/images/backgrounds/mission_bg.jpg')">
...
<li class="badge badge-pill badge-primary"><a href="<?php echo base_url();?>" class="color-white"> Home /</a> Mission</li>
</ul>
</div>
</div>
</section>
...
<h2 class="xs-title">Drop Us a Line</h2>
<p class="small">To learn more about registering your charity with us visit our "<span class="color-green">Work with us</span>" site. By calling <span class="color-green">+44(0) 111 222 3333.</span></p>
